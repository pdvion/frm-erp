      ...
      <div className="space-y-1">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={disabled}
            className="px-3 py-2 bg-theme-tertiary border border-theme rounded-lg hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"

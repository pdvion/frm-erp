    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        <select
          ...
          className="px-3 py-2 border border-theme-input rounded-lg text-sm focus:ring-2 focus:ring-blue-500 bg-theme-input text-theme"
        >
        ...
        >
          ...
          <label
            ...
            className="cursor-pointer flex items-center justify-center gap-2 text-sm text-theme-muted"
          >
            {isUploading ? (
      ...
      {groupedAttachments.some((g) => g.items.length > 0) && (
        <div className="space-y-4">
          {groupedAttachments
            ...
            .map((group) => (
              <div key={group.value}>
                <h4 className="text-xs font-medium text-theme-muted uppercase tracking-wider mb-2">
                ...
                <div className="space-y-1">
                  {group.items.map((attachment) => (
                    <div
                      key={attachment.id}
                      className="flex items-center gap-3 p-2 border border-theme rounded-lg bg-theme-card hover:bg-theme-hover"
                    >
      ...
      {attachments.length === 0 && (
        <div className="text-center py-8 text-theme-muted border-2 border-dashed border-theme rounded-lg">
          <FileText size={32} className="mx-auto mb-2 text-theme-muted" />

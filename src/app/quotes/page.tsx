...
const statusConfig: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
  ...
  SENT: { label: "Enviada", color: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400", icon: <Send className="w-4 h-4" /> },
  RECEIVED: { label: "Recebida", color: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400", icon: <FileText className="w-4 h-4" /> },
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-800 rounded-lg p-4 flex items-center gap-3">
          ...
          <span className="text-red-600 dark:text-red-400">Erro ao carregar cotações</span>
        </div>

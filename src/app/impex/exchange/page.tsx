...
const STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  PARTIALLY_LIQUIDATED: { label: "Parcialmente Liquidado", color: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400" },
  LIQUIDATED: { label: "Liquidado", color: "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" },
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Button
            onClick={() => window.location.href = "/impex/exchange/new"}

...
import { Ship, Anchor, Users, Package, FileText, Loader2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-theme-secondary rounded-lg">
            ...
            <p className="text-sm text-theme-muted">
              Gestão completa de processos de importação com timeline de eventos, documentos e custos.
            </p>

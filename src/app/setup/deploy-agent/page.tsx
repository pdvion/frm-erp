...
export default function DeployAgentPage() {
  ...
  return (
    <div className="min-h-screen bg-theme p-4 md:p-6">
      ...
      <PageHeader
        title="Deploy Agent"
        subtitle="Importação inteligente de XMLs fiscais para configuração automática do ERP"
        icon={<Bot className="w-6 h-6" />}
        actions={
          <Link href="/setup/deploy-agent/wizard">
                  ...
                  <td colSpan={6} className="px-4 py-16">
                    <div className="flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-theme-muted max-w-md mb-6">
                        {statusFilter === "PENDING"
                          ? "Use o Wizard de Configuração para importar XMLs e configurar o ERP automaticamente."
                  ...
                  <tr key={invoice.id} className="hover:bg-theme-hover transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-2">
                        <Link
                          href={`/setup/deploy-agent/${invoice.id}`}
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link
          href="/setup/deploy-agent/wizard"
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-theme">Wizard de Configuração</p>
              <p className="text-sm text-theme-muted">Configure o ERP automaticamente</p>
            </div>
          </div>
        ...
        <Link
          href="/setup/deploy-agent/analysis"
          className="flex items-center justify-between p-4 bg-theme-card rounded-lg border border-theme hover:border-blue-500 transition-colors group"
        >
          <div className="flex items-center gap-3">
            <div className="p-2 bg-green-500/10 rounded-lg">
            ...
            <div>
              <p className="font-medium text-theme">Análise Detalhada</p>
              <p className="text-sm text-theme-muted">Visualizar dados fiscais e tributários</p>
            </div>
          </div>
          <ArrowRight className="w-5 h-5 text-theme-muted group-hover:text-blue-500 transition-colors" />
        </Link>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-theme">Configurar SEFAZ</p>
              <p className="text-sm text-theme-muted">Integração automática de NFe</p>
            </div>
          </div>
          <ArrowRight className="w-5 h-5 text-theme-muted group-hover:text-blue-500 transition-colors" />
        </Link>

          ...
          <>
            ...
            {data.flowData.length > 0 && (
              <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
                <h3 className="font-medium text-gray-900 mb-4">Fluxo Diário</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
              <div className="px-4 py-3 border-b bg-gray-50">
                <h3 className="font-medium text-gray-900">Detalhamento por Dia</h3>
              </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Saldo Dia</th>
              ...
              {data.flowData.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">Nenhuma movimentação no período</p>
                </div>
              )}
            </div>
          </>

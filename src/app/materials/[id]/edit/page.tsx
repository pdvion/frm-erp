  ...
  useEffect(() => {
    if (material) {
      setFormData({
        ...
        requiresQualityCheck: material.requiresQualityCheck,
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Editar Material</h1>
                <p className="text-sm text-gray-500">Código: {material.code}</p>
              </div>
            </div>
            <CompanySwitcher />
          </div>

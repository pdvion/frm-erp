  ...
  useEffect(() => {
    if (material) {
      setFormData({
        ...
        unitConversionFactor: Number(material.unitConversionFactor) ?? 1,
        categoryId: material.categoryId ?? "",
        minQuantity: Number(material.minQuantity) ?? 0,
        maxQuantity: Number(material.maxQuantity) ?? 0,
        minQuantityCalcType: material.minQuantityCalcType ?? "MANUAL",
        avgDeliveryDays: Number(material.avgDeliveryDays) ?? 0,
        ncm: material.ncm ?? "",
        ipiRate: Number(material.ipiRate) ?? 0,
        icmsRate: Number(material.icmsRate) ?? 0,

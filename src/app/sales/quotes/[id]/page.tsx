              ...
              <div className="space-y-3">
                ...
                {Number(quote.discountPercent) > 0 && (
                  <div className="flex justify-between text-red-600">
                    <span>Desconto ({Number(quote.discountPercent)}%)</span>
                    <span>-{formatCurrency(Number(quote.subtotal) * Number(quote.discountPercent) / 100)}</span>
                  </div>
                )}
